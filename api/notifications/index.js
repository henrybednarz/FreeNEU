...
async function handlePost(req, res) {
    ...
    const response = await subscribePush(email, subscription, name);
...
async function subscribePush(email, subscription, name = null) {
    const query = `
    ...
    try {
        ...
        console.error('Database error (subscribePush):', error);
